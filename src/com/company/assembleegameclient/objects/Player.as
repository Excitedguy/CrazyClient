...
public class Player extends Character
    {
        ...
        public function doShoot(arg1:int, arg2:int, arg3:XML, arg4:Number, arg5:Boolean):void
        {
            ...
            if (arg2 == 580 && Parameters.data_.cultistStaffDisable)
            {
                loc11 = loc11 + Math.PI;
            }
            while (loc7 < loc8)
            {
                loc1 = getBulletId();
                if (arg2 == 8608 && Parameters.data_.etheriteDisable)
                {
                    loc11 = loc11 + (loc1 % 2 == 0 ? -0.0436332312999 : 0.0436332312999);
                }
                else if (arg2 == 596 && Parameters.data_.offsetColossus)
                {
                    loc11 = loc11 + (loc1 % 2 == 0 ? -Parameters.data_.coloOffset : Parameters.data_.coloOffset);
                }
                else if (arg2 == 588 && Parameters.data_.voidbowDisable)
                {
                    loc11 = loc11 + (loc1 % 2 == 0 ? -0.06 : 0.06);
                }
                else if (arg2 == 3113 && Parameters.data_.spiritdaggerDisable)
                {
                    loc11 = loc11 + (loc1 % 2 == 0 ? -0.0433332312999 : 0.0423332312999);
                }
                loc2 = FreeList.newObject(Projectile) as Projectile;
                ...
                {
                    SoundEffectLibrary.play(loc2.sound_, 0.75, false);
                }
